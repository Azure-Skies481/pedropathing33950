...
public class Constants {
    ...
    public static DriveEncoderConstants localizerConstants = new DriveEncoderConstants()
            ...
            .rightFrontMotorName("rf")   // e.g. "right_front_motor"
            .rightRearMotorName("rr")    // e.g. "right_rear_motor"
            .leftRearMotorName("lr")     // e.g. "left_rear_motor"
            .leftFrontMotorName("lf")    // e.g. "left_front_motor"
